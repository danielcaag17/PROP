...
class Main {
    public static void main(String[] args) {
        ...
        BranchBound bb = new BranchBound(freqs_mat, dist_mat);
        System.out.println("Solution: " + bb.algorithm());
    }
}
/*
        double[][] freqs_mat = {{0.5, 0.4, 0.1, 0.3},
                             {0.2, 0.7, 0.2, 0.4},
                             {0.6, 0.3, 0.3, 0.5},
                             {0.1, 0.4, 0.1, 0.3}};
        double[][] dist_mat = {{21, 34, 31, 43},
                             {20, 35, 32, 44},
                             {20, 34, 33, 45},
                             {21, 34, 31, 43}};
        double[][] freqs_mat = {{0, 1, 2, 3},
                             {1, 0, 4, 2},
                             {2, 4, 0, 1},
                             {3, 2, 1, 0}};
        double[][] dist_mat = {{0, 2, 3, 1},
                             {2, 0, 1, 4},
                             {3, 1, 0, 2},
                             {1, 4, 2, 0}};
*/
